...
public:
    ...
    void setupUi(QMainWindow *game)
    {
        ...
        game->resize(800, 600);
        game->setContextMenuPolicy(Qt::ContextMenuPolicy::DefaultContextMenu);
        QIcon icon;
        icon.addFile(QString::fromUtf8(":/ico/bnb_crypto_icon_264371.ico"), QSize(), QIcon::Mode::Normal, QIcon::State::Off);
    ...
    {
        game->setWindowTitle(QCoreApplication::translate("game", "block  shooter", nullptr));
